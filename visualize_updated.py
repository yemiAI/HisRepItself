...
if __name__ == '__main__':
    ...
    parser.add_argument("--GT_frames", type=str, help ="Ground truth frames 60 frames")
    parser.add_argument("--attn_output_frames", type=str, help ="Ground truth plus 10 frames attention model")

    args = parser.parse_args()

    l = Loader(args.GT_frames)
    l_output = Loader(args.attn_output_frames)
    l_copy = l.nvals.copy()
    print(l_copy.shape)
